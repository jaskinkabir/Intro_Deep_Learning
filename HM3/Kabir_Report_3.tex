...
\begin{enumerate}[label=1\alph*. ]
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|>{\centering\arraybackslash}m{2.2cm}|>{\centering\arraybackslash}m{2cm}|>{\centering\arraybackslash}m{2cm}|>{\centering\arraybackslash}m{1.8cm}|>{\centering\arraybackslash}m{1.5cm}|>{\centering\arraybackslash}m{1.5cm}|}
            \hline
            \textbf{Model} & \textbf{Param Count} & \textbf{Train Time (s)} & \textbf{Inf Time (ms)} & \textbf{Overfit (\%)} & \textbf{Acc (\%)} \\
            \hline
            LSTM-20       & 148801  & 346.11  & 0.45  & 3.83  & 56.61 \\
            LSTM-Adj-20   & 113093  & 339.66  & 2.02  & -1.96 & 57.29 \\
            \hline
            GRU-20        & 115777  & 213.82  & 1.23  & 4.17  & 56.89 \\
            GRU-Adj-20    & 176477  & 262.32  & 1.96  & -0.01 & 57.43 \\
            \hline
            LSTM-30       & 148801  & 359.37  & 0.35  & 4.00  & 56.69 \\
            LSTM-Adj-30   & 113093  & 333.88  & 1.35  & -1.75 & 57.05 \\
            \hline
