...
print(f"Num Params: {sum(p.numel() for p in alex_100_ndp.parameters())}")
alex_100_ndp.train_model(
    epochs=100,
...
torch.save(alex_100_ndp, 'models/alex_100_ndp.pth')
alex_100_ndp.plot_training()
plt.savefig('figures/alex_100_ndp.png')