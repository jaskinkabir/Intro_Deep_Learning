...
print(f"Num Params: {sum(p.numel() for p in alex_10_dp.parameters())}")
alex_10_dp.train_model(
    epochs=100,
...
torch.save(alex_10_dp, 'models/alex_10_dp.pth')
alex_10_dp.plot_training()
plt.savefig('figures/alex_10_dp.png')